...
Usage:
    python3 _gen_react_sections_logo_cloud.py          # write all 4 previews
    python3 _gen_react_sections_logo_cloud.py --check  # detect drift, exit 1
"""
...
def main() -> int:
    ...
    if drift:
        ...
        print("Run: python3 _gen_react_sections_logo_cloud.py")
        return 1
    if args.check:
