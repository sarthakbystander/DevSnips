...
/**
 * DevSnips React Breadcrumbs — With Home.
 *
 * The first level is the application home, rendered with a leading home
 * icon. When visible "Home" text accompanies the icon, the icon is purely
 * decorative and rendered aria-hidden by `<BreadcrumbLink icon>`. For an
 * icon-only home link, pass a real `aria-label` (e.g. `aria-label="Home"`)
 * instead of visible text so the link keeps an accessible name.
 */
