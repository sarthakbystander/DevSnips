 ...
 * Treatment: contained (tablist inside a bordered surface)
 *
...
const LIST_HORIZONTAL_CLASSES = "inline-flex max-w-full flex-wrap items-center gap-1 rounded-[var(--ds-radius-md)] border border-[var(--ds-color-border)] bg-[var(--ds-color-surface-subtle)] p-1";
...
const TRIGGER_SELECTED_CLASSES = "bg-[var(--ds-color-surface)] text-[var(--ds-color-foreground)] shadow-[var(--ds-shadow-xs)]";
const TRIGGER_IDLE_CLASSES = "text-[var(--ds-color-muted-foreground)] hover:text-[var(--ds-color-foreground)]";
