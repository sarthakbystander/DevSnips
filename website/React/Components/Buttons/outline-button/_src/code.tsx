  ...
  return (
    <button
      ...
      className={cx(
        ...
        "border-[var(--ds-color-border-strong)] bg-transparent text-[var(--ds-color-foreground)] hover:bg-[var(--ds-color-surface-hover)] active:bg-[var(--ds-color-surface-active)]",
        SIZES[size],
        block && "w-full",
        className,
      )}
