...
/**
/**
 * DevSnips React Pagination — large treatment (`size="lg"`, 44px controls)
 * for prominent content navigation such as featured articles and case
 * studies. Built on the reference compound core; only the default density
 * changes. 44px controls also make comfortable touch targets.
 *
