...
```tsx
import { DisabledInput } from './code';

<DisabledInput label="Workspace name" placeholder="Acme design" />
```
...
<DisabledInput label="Billing email" placeholder="billing@example.com" />
```
