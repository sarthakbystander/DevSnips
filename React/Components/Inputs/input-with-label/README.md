...
```tsx
import { InputWithLabel } from './code';

<InputWithLabel label="Workspace name" placeholder="Acme design" />
```
...
<InputWithLabel label="Billing email" placeholder="billing@example.com" />
```
