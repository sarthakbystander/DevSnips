...
export function InputWithCharacterCount({ label = "Workspace name", helperText = "Keep names short for navigation.", size = "md", tone = "default", id, className, value, defaultValue = "", onChange, maxLength = 64, ...props }) {
