...
```tsx
import { InputWithCharacterCount } from './code';

<InputWithCharacterCount label="Workspace name" placeholder="Acme design" />
```
...
<InputWithCharacterCount label="Billing email" placeholder="billing@example.com" />
```
