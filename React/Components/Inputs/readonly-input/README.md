...
```tsx
import { ReadonlyInput } from './code';

<ReadonlyInput label="Workspace name" placeholder="Acme design" />
```
...
<ReadonlyInput label="Billing email" placeholder="billing@example.com" />
```
