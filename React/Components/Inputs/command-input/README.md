...
```tsx
import { CommandInput } from './code';

<CommandInput label="Workspace name" placeholder="Acme design" />
```
...
<CommandInput label="Billing email" placeholder="billing@example.com" />
```
