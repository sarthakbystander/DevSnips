...
export function InputWithValidation({ label = "Billing email", helperText = "Use the address that receives invoices.", validate = (value) => value.includes("@") ? undefined : "Enter a valid email address.", size = "md", id, className, value, defaultValue = "", onChange, ...props }) {
