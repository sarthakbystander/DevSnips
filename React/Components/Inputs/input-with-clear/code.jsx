...
export function InputWithClear({ label = "Input with Clear", helperText, error, success, size = "md", tone = "default", id, className, value, defaultValue = "", onChange, clearLabel = "Clear input", onClear,  ...props }) {
