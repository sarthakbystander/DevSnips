...
URL field for repository and endpoint values.

## Usage

```tsx
import { UrlInput } from './code';

<UrlInput label="Workspace name" placeholder="Acme design" />
```
...
<UrlInput label="Billing email" placeholder="billing@example.com" />
```
