...
```tsx
import { PasswordInput } from './code';

<PasswordInput label="Workspace name" placeholder="Acme design" />
```
...
<PasswordInput label="Billing email" placeholder="billing@example.com" />
```
