...
export interface CheckboxWithDescriptionProps {
  label: ReactNode;
...
/**
 * Checkbox with a strong label plus a supporting description. The label is the
 * primary affordance; the description gives context. The description is wired
 * to the input with `aria-describedby`. Built on the native
 * `<input type="checkbox">`.
 */
