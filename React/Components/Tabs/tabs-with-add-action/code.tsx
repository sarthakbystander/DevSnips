 ...
 * Treatment: soft (subtle background for the selected tab)
 *
...
export interface TabsAddActionProps
  extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, "children"> {
  /** Accessible name for the action (required). */
  "aria-label": string;
  disabled?: boolean;
  className?: string;
  children?: ReactNode;
...
export function TabsAddAction({ className, children, ...rest }: TabsAddActionProps) {
  return (
    <button
      type="button"
      className={cx(
