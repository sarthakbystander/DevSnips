  ...
  >
    ...
    >
            <span className="min-w-0 flex-1">
              ...
              {option.description ? <span className="mt-0.5 block truncate text-xs text-[var(--ds-color-muted-foreground)]">
                  {option.description}
                </span> : null}
            </span>
            {isSelected ? <CheckIcon className="mt-0.5 shrink-0 text-[var(--ds-color-primary)]" /> : null}
          </button>;
  })}
    </div>;
}
