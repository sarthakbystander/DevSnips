...
/**
 * Custom accessible select implementing the WAI-ARIA combobox/listbox pattern.
 * Trigger = <button aria-haspopup="listbox" aria-expanded aria-controls
 * aria-activedescendant>; panel = role="listbox" of role="option" rows with
 * aria-selected. Keyboard: ArrowUp/Down moves the active option, Home/End jump
 * to first/last enabled, Enter/Space selects, Escape closes. Controlled
 * (value/onChange) and uncontrolled (defaultValue) modes both supported.
 */
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        >
          {leadingIcon ? (
            <span className="pointer-events-none absolute left-3 text-[var(--ds-color-muted-foreground)]">{leadingIcon}</span>
          ) : null}
