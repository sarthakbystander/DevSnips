...
Two-pane split hero comparing value vs. included features.
...
**Tags:** hero, split, comparison  
**Features:** light/dark, responsive, join-on-desktop

## Usage

1. Copy the contents of `hero-split.html` into your page.
