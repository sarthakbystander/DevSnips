...
Navbar with a click-to-open mega menu panel.
...
**Tags:** nav, navbar, mega-menu  
**Features:** click-away close, keyboard, aria-expanded

## Usage

1. Copy the contents of `navbar-mega-menu.html` into your page.
