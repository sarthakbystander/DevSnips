...
Verifies behavior-critical guarantees (not cosmetics):
  ...
  - generator: `_gen/generators/_gen_react_sections_testimonials.py --check` reports no
...
def generator_checks() -> None:
    drift = subprocess.run(
        [sys.executable, str(ROOT / "_gen/generators/_gen_react_sections_testimonials.py"), "--check"],
        capture_output=True,
        text=True,
    )
