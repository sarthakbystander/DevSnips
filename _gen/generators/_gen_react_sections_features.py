...
Usage:
    python3 _gen/generators/_gen_react_sections_features.py          # write all 8 previews
    python3 _gen/generators/_gen_react_sections_features.py --check  # detect drift, exit 1
"""
...
def main() -> int:
    ...
    if drift:
        ...
        print("Run: python3 _gen/generators/_gen_react_sections_features.py")
        return 1
    if args.check:
