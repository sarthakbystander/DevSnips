...
fixes that by reusing the exact preview architecture the buttons family uses.
    ...
    python3 _gen/generators/_gen_react_inputs_preview.py            # rewrite all previews
    python3 _gen/generators/_gen_react_inputs_preview.py --check    # report drift, no writes
