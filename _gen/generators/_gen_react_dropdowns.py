...
``_gen/registries/_gen_react_dropdowns_registry.py``, then run:

    python3 _gen/generators/_gen_react_dropdowns.py            # write everything
    python3 _gen/generators/_gen_react_dropdowns.py --check    # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen" / "registries" / "_gen_react_dropdowns_registry.py"
