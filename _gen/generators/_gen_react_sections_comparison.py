...
Usage:
    python3 _gen/generators/_gen_react_sections_comparison.py
    python3 _gen/generators/_gen_react_sections_comparison.py --check
"""
...
def main() -> int:
    ...
    if drift:
        ...
        print("Run: python3 _gen/generators/_gen_react_sections_comparison.py")
        return 1
