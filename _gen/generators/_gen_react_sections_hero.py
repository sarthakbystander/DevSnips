...
Usage:
    python3 _gen/generators/_gen_react_sections_hero.py          # write all 4 previews
    python3 _gen/generators/_gen_react_sections_hero.py --check  # detect drift, exit 1
"""
...
def main() -> int:
    ...
    if drift:
        ...
        print("Run: python3 _gen/generators/_gen_react_sections_hero.py")
        return 1
    if args.check:
