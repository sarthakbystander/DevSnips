...
and consistent metadata.
    ...
    python3 _gen/generators/_gen_react_buttons.py            # write everything
    python3 _gen/generators/_gen_react_buttons.py --check   # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen" / "registries" / "_gen_react_buttons_registry.py"
