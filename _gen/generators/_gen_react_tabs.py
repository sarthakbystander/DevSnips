...
``_gen/registries/_gen_react_tabs_registry.py``, then run:

    python3 _gen/generators/_gen_react_tabs.py            # write everything
    python3 _gen/generators/_gen_react_tabs.py --check    # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen" / "registries" / "_gen_react_tabs_registry.py"
