 ...
 * helperText message rendered below the field and linked to the trigger
 * via aria-describedby. When helperText is present the trigger carries
 * `aria-describedby` pointing at the helper message id so assistive tech
 * announces the hint alongside the field. Full keyboard nav (ArrowUp/Down/
 * Home/End/Enter/Space/Escape/Tab), role=listbox of role=option rows with
