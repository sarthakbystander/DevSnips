...
export function InlineEditSelect({
  ...
  return <div ref={rootRef} className={cx("w-full", className)}>
      {label ? <span id={labelId} className="mb-2 block text-[13px] font-medium leading-5 text-[var(--ds-color-foreground)]">
          {label}
        </span> : null}
