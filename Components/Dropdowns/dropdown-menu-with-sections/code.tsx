...
/**
 * DevSnips React Dropdown Menu — With Sections.
 *
 * The shared menu core composed with `<DropdownMenuLabel>` +
 * `<DropdownMenuGroup>` to group related actions under readable section
 * headings (uppercase, tracked, smaller type — distinguishable without
 * relying on color), separated by `<DropdownMenuSeparator>` rules.
 * Identical core + behavior as the reference dropdown-menu variant.
 */
