...
export interface RadioWithHelperProps {
  label: ReactNode;
...
/**
 * Radio with a visible label plus helper text. The helper is wired to the
 * input with `aria-describedby` so assistive tech announces it alongside the
 * label. Built on the native `<input type="radio">`.
 */
...
export default RadioWithHelper;
