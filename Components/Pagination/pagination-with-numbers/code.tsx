...
/**
/**
 * DevSnips React Pagination — explicit numbered page navigation. Built on the
 * reference compound core: compose one `<PaginationLink>` per page and let
 * the current page carry `aria-current="page"`. Intended for small, known
 * page counts; for large datasets use the ellipsis variant.
 *
