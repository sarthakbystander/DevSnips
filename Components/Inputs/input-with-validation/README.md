...
```tsx
import { InputWithValidation } from './code';

<InputWithValidation label="Workspace name" placeholder="Acme design" />
```
...
<InputWithValidation label="Billing email" placeholder="billing@example.com" />
```
