...
```tsx
import { InputWithError } from './code';

<InputWithError label="Workspace name" placeholder="Acme design" />
```
...
<InputWithError label="Billing email" placeholder="billing@example.com" />
```
