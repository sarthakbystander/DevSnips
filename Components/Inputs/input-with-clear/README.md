...
```tsx
import { InputWithClear } from './code';

<InputWithClear label="Workspace name" placeholder="Acme design" />
```
...
<InputWithClear label="Billing email" placeholder="billing@example.com" />
```
