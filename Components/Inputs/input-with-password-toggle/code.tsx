...
export interface InputWithPasswordToggleProps extends Omit<InputHTMLAttributes<HTMLInputElement>, "size" | "prefix"> {
  label?: string;
  helperText?: string;
  error?: string;
  success?: string;
...
export function InputWithPasswordToggle({ label = "Password", helperText, error, success, size = "md", tone = "default", id, className, disabled, readOnly, autoComplete = "current-password", ...props }: InputWithPasswordToggleProps) {
