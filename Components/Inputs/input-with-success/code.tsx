...
export interface InputWithSuccessProps extends Omit<InputHTMLAttributes<HTMLInputElement>, "size" | "prefix"> {
  label?: string;
  helperText?: string;
  error?: string;
  success?: string;
...
export function InputWithSuccess({
...
export default InputWithSuccess;
