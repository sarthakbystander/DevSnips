...
```tsx
import { InputWithTrailingIcon } from './code';

<InputWithTrailingIcon label="Workspace name" placeholder="Acme design" />
```
...
<InputWithTrailingIcon label="Billing email" placeholder="billing@example.com" />
```
