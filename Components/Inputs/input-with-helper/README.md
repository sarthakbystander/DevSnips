...
```tsx
import { InputWithHelper } from './code';

<InputWithHelper label="Workspace name" placeholder="Acme design" />
```
...
<InputWithHelper label="Billing email" placeholder="billing@example.com" />
```
