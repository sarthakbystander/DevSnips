...
/**
 * Checkbox with an associated validation message. Sets `aria-invalid="true"`
 * and links the error message with `aria-describedby`, so the failure is
 * communicated beyond color. The indicator border + check take the
 * destructive token. Built on the native `<input type="checkbox">`.
 */
