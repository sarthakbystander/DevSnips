...
export function TimezoneSelect({
  ...
  >
          <span className="flex min-w-0 flex-1 items-center gap-2">
            {selected && selected.offset ? <span className="shrink-0 font-mono text-[12px] text-[var(--ds-color-muted-foreground)]">
                {selected.offset}
              </span> : null}
...
function TimezonePanel({
  ...
  >
          <span className="flex min-w-0 items-center gap-2">
            {option.offset ? <span className="w-16 shrink-0 font-mono text-[12px] text-[var(--ds-color-muted-foreground)]">
                {option.offset}
              </span> : null}
