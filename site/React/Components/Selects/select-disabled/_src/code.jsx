...
export function SelectDisabled({
  ...
  >
    ...
    className={cx(
      ...
      disabled ? "pointer-events-none border-[var(--ds-color-border)] bg-[var(--ds-color-muted)] text-[var(--ds-color-muted-foreground)] opacity-60" : cx(error ? "border-[var(--ds-color-destructive)]" : "border-[var(--ds-color-border)] focus:border-[var(--ds-color-border-strong)]"),
      SIZES[size],
      className
    )}
  >
