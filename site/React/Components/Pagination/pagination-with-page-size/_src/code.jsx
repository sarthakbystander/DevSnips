...
function PaginationPageSize({
  ...
  return <div className={cx("flex items-center gap-2", className)}>
      <label
    htmlFor={selectId}
...
export { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationPrevious, PaginationNext, PaginationEllipsis, PaginationPageSize };
