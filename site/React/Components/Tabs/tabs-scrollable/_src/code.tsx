 ...
 * Treatment: scrollable (soft treatment; horizontal overflow handled by scrolling)
 *
...
const LIST_HORIZONTAL_CLASSES = "flex max-w-full items-center gap-1 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden";
