...
export function PasswordInput({ label = "Password", helperText, error, success, size = "md", tone = "default", id, className, disabled, readOnly, autoComplete = "current-password", ...props }) {
