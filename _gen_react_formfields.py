...
``tsx_header`` in ``_gen_react_formfields_registry.py``, then run:

    python3 _gen_react_formfields.py            # write everything
    python3 _gen_react_formfields.py --check    # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen_react_formfields_registry.py"
