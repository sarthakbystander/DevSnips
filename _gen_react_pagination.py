...
``_gen_react_pagination_registry.py``, then run:

    python3 _gen_react_pagination.py            # write everything
    python3 _gen_react_pagination.py --check    # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen_react_pagination_registry.py"
