...
```
Vanilla/Sections/<Family>/<variant-slug>/
├── <variant-slug>.html   # self-contained: inline <style> + <script>, copy-paste ready
├── metadata.json         # DevSnips metadata schema (type: "section")
...
- `sections-index.html` — filterable gallery of all 65 sections
- `sections-showcase.html` — every section rendered live on one page (each in an isolated iframe)
