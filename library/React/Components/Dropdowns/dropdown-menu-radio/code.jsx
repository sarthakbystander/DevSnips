...
function DropdownMenuRadioGroup({
  ...
  return <DropdownMenuRadioGroupContext.Provider value={{ value: actualValue, select }}>
      <div role="group" {...rest}>
        {children}
      </div>
...
export { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuGroup, DropdownMenuSeparator, DropdownMenuRadioGroup, DropdownMenuRadioItem };
