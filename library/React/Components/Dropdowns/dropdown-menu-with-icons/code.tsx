...
/**
 * DevSnips React Dropdown Menu — With Icons.
 *
 * The shared menu core with meaningful leading icons on items. Icons are
 * rendered aria-hidden (the text label carries the accessible name), use a
 * consistent 16px slot, and follow the muted-foreground token — or the
 * destructive token on destructive items — so state never relies on color
 * alone. Identical core + behavior as the reference dropdown-menu variant.
 */
