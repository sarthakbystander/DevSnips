...
/**
 * DevSnips React Dropdown Menu — With Shortcuts.
 *
 * The shared menu core with informational keyboard shortcuts aligned to the
 * trailing edge of each item (`shortcut` prop). Shortcuts are aria-hidden
 * decoration exposed to assistive technology via `aria-keyshortcuts`, so
 * they never pollute the item's accessible name. Identical core + behavior
 * as the reference dropdown-menu variant.
 */
