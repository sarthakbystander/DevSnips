...
/**
 * DevSnips React Breadcrumbs — With Icons.
 *
 * Any level may carry a meaningful leading icon via the `icon` prop on
 * `<BreadcrumbLink>` / `<BreadcrumbCurrent>`. Icons are optional ReactNode
 * values rendered aria-hidden — the visible label always carries the
 * accessible name. No icon library is required; pass any SVG node.
 */
