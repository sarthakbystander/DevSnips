...
```tsx
import { InputWithSuccess } from './code';

<InputWithSuccess label="Workspace name" placeholder="Acme design" />
```
...
<InputWithSuccess label="Billing email" placeholder="billing@example.com" />
```
