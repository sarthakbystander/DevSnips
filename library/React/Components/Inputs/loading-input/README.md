...
```tsx
import { LoadingInput } from './code';

<LoadingInput label="Workspace name" placeholder="Acme design" />
```
...
<LoadingInput label="Billing email" placeholder="billing@example.com" />
```
