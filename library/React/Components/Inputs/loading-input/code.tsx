...
export interface LoadingInputProps extends Omit<InputHTMLAttributes<HTMLInputElement>, "size" | "prefix"> {
  label?: string;
  helperText?: string;
  error?: string;
  success?: string;
...
export function LoadingInput({ label = "Repository", loadingText = "Checking repository…", size = "md", id, className, disabled = true, ...props }: LoadingInputProps) {
