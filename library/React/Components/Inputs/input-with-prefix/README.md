...
```tsx
import { InputWithPrefix } from './code';

<InputWithPrefix label="Workspace name" placeholder="Acme design" />
```
...
<InputWithPrefix label="Billing email" placeholder="billing@example.com" />
```
