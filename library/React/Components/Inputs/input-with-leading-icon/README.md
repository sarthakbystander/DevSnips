...
```tsx
import { InputWithLeadingIcon } from './code';

<InputWithLeadingIcon label="Workspace name" placeholder="Acme design" />
```
...
<InputWithLeadingIcon label="Billing email" placeholder="billing@example.com" />
```
