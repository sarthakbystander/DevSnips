...
```tsx
import { InputWithSuffix } from './code';

<InputWithSuffix label="Workspace name" placeholder="Acme design" />
```
...
<InputWithSuffix label="Billing email" placeholder="billing@example.com" />
```
