...
```tsx
import { InlineEditInput } from './code';

<InlineEditInput label="Workspace name" placeholder="Acme design" />
```
...
<InlineEditInput label="Billing email" placeholder="billing@example.com" />
```
