...
```tsx
import { InputWithPasswordToggle } from './code';

<InputWithPasswordToggle label="Workspace name" placeholder="Acme design" />
```
...
<InputWithPasswordToggle label="Billing email" placeholder="billing@example.com" />
```
