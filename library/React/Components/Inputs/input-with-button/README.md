...
```tsx
import { InputWithButton } from './code';

<InputWithButton label="Workspace name" placeholder="Acme design" />
```
...
<InputWithButton label="Billing email" placeholder="billing@example.com" />
```
