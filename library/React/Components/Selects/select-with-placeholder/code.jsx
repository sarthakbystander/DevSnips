...
export function SelectWithPlaceholder({
  ...
  >
          {selected ? <span className="flex-1 truncate">{selected.label}</span> : <span className="flex flex-1 items-center gap-1.5 truncate text-[var(--ds-color-muted-foreground)]">
