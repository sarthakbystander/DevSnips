  ...
  >
    ...
    >
      ...
      className={cx(
        ...
        checked ? "border-[var(--ds-color-primary)] bg-[var(--ds-color-primary)] text-[var(--ds-color-primary-foreground)]" : "border-[var(--ds-color-border)] bg-[var(--ds-color-surface-elevated)]",
        i === activeIndex && !checked ? "border-[var(--ds-color-border-strong)]" : "",
        option.disabled && checked ? "opacity-60" : ""
      )}
    >
              {checked ? <svg className="size-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
