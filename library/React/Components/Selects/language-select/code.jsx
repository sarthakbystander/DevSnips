...
export function LanguageSelect({
  ...
  >
          ...
          <span className={cx("flex-1 truncate", !selected && "text-[var(--ds-color-muted-foreground)]")}>
            {selected ? <span className="inline-flex items-center gap-2">
                <span className="truncate">{selected.label}</span>
                {selected.nativeName ? <span className="truncate text-[var(--ds-color-muted-foreground)]">{selected.nativeName}</span> : null}
              </span> : placeholder}
          </span>
...
function LanguagePanel({
  ...
  >
          <span className="flex min-w-0 items-baseline gap-2">
            ...
            {option.nativeName ? <span className="truncate text-[var(--ds-color-muted-foreground)]">{option.nativeName}</span> : null}
          </span>
