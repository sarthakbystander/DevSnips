...
function CheckGlyph() {
  return <svg className="shrink-0 size-4 text-[var(--ds-color-primary)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
function AvatarSlot({ option, className }) {
  if (option?.avatar) {
...
function ListboxPanel({
  ...
  >
          ...
          <span className="flex min-w-0 flex-1 flex-col leading-tight">
            ...
            {option.description ? <span className="truncate text-[11px] text-[var(--ds-color-muted-foreground)]">{option.description}</span> : null}
          </span>
