...
``_gen_react_switches_registry.py``, then run:

    python3 _gen_react_switches.py            # write everything
    python3 _gen_react_switches.py --check    # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen_react_switches_registry.py"
