...
``_gen_react_selects_registry.py``, then run:

    python3 _gen_react_selects.py            # write everything
    python3 _gen_react_selects.py --check    # report drift, no writes
...
def main(check: bool = False) -> None:
    ...
    reg = ROOT / "_gen_react_selects_registry.py"
