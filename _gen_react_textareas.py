...
``_gen_react_textareas_registry.py``, then run:

    python3 _gen_react_textareas.py            # write everything
    python3 _gen_react_textareas.py --check    # report drift, no writes
...
def main(check=False):
    if not COMPONENTS:
        ...
        reg = ROOT / "_gen_react_textareas_registry.py"
